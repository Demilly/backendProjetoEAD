...
public class MatriculaController {
    ...
    @DeleteMapping
    public ResponseEntity<Void> cancelarMatricula(@RequestParam String uuidUsuario,
                                                  @RequestParam String uuidCurso) {
        matriculaService.cancelarMatricula(uuidUsuario, uuidCurso);
